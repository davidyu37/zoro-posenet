...
function setup() {
  // video = createVideo(["oni-pose.mp4"], vidLoad);
...
window.addEventListener("DOMContentLoaded", function() {
  ...
  normalBtn = addButton("normal", toggleNormal);
  oniBtn = addButton("oni", toggleOni);
  giriBtn = addButton("giri", toggleGiri);
...
function draw() {
  ...
  if (collecting) {
    ...
    text(`${targetLabel}`, width / 4, height);
  }
